...
namespace BookExchangerWebApi.Controllers
{
    ...
    public class BookController : ApiController{
        ...
        [Route("acceptedBooks/{user}")]
        public IHttpActionResult GetBooks(int user)
        {
            var book = repo.GetBooks(user);
            if (book != null)
            {
                return Ok(book);
            }
        ...
        [Route("{bookId}/point", Name = "GetBookspoint")]
        public IHttpActionResult GetBooksPoint(int bookId)
        {
            var booksPoint = repo.GetBookPoint(bookId);
            if (booksPoint != null)
            {
